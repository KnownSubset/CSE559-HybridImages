...
HighFiImage = im2double(imread('/Users/nathan/Development/CSE559-HybridImages/skull.png'))/255;
HighFiImage = rgb2gray(HighFiImage);
LowFiImage = im2double(imread('/Users/nathan/Development/CSE559-HybridImages/BuffaloBill.jpg'))/255;
LowFiImage = rgb2gray(LowFiImage);

hs =50;
fftsize = 1024;
%Gaussian = fspecial('gaussian', hs*2+1, 5);
Gaussian = fspecial('gaussian', hs*2+1, 3.75);
...
%Gaussian = fspecial('gaussian', hs*2+1, 5);
Gaussian = fspecial('gaussian', hs*2+1, 7);
FftHighFiImage = fft2(HighFiImage, fftsize, fftsize);
FftGaussian = fft2(Gaussian, fftsize, fftsize);
...
imwrite(HybridImage, '/Users/nathan/Development/CSE559-HybridImages/buffaloBill-filtered.jpg');